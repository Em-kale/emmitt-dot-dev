    ...
    <div class="list-container">
        <details>
            ...
            <div class="sub-list-1">
                <p class="list-item">Graph Traversal Visualizer</p>
                <p class="list-item">
                    <a class="link"
                    href="https://github.com/Em-kale/carleton-mail-delivery-robot"
                    target="_blank">
                        Autonomous Mail Delivery
                    </a>
                </p>
                <p class="list-item">
                    <a class="link" href="https://github.com/Em-kale/proof"
                    target="_blank">
                        Proof
                    </a>
                </p>
                <p class="list-item">
                    <a class="link"
                    href="https://github.com/Em-kale/graph-validator-generator"
                    target="_blank">
                        Near Staking Web Crawler
                    </a>
                </p>
                <p class="list-item">This site</p>
            </div>
        </details>
        <details>
            <summary>
            ...
            <div class="sub-list-1">
                <p class="list-item">
                    <a class="link" href="https://github.com/Em-kale"
                    target="_blank">
                        Github
                    </a>
                </p>
                <p class="list-item">
                    <a class="link" href="https://www.linkedin.com/in/emmittl"
                    target="_blank">
                        LinkedIn
                    </a>
                </p>
        ...
        <p class="list-item" hx-target="#home-container"
        hx-post="/about-me" hx-swap="innerHTML">
            About Me
        </p>
    </div>
    """
